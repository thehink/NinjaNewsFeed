...
const FeedActions = Reflux.createActions({
  ...
  'loadPost': {children: ['completed', 'failed']},
  'newPost': {children: ['completed', 'failed']},
  'deletePost': {children: ['completed', 'failed']},
  'like': {children: ['completed', 'failed']},
  'loadComments': {children: ['completed', 'failed']},
  'newComment': {children: ['completed', 'failed']},
